...
| **驱动机制** | 简单的局部规则反复迭代 → 涌现复杂宏观结构 🧐 | 简单的局部博弈反复加码 → 涌现复杂内卷生态 🫠   |
|          | 每个自相似单元只“看得见”自己所在的局部规则       | 每个个体只“看得见”身边的对手，卷向未知的终点      |
| **边际效益** | 结构复杂度不因尺度而递减，自相似/无限细节恒定存在🤏 | 每多努力一点产出回报下降（竞争收益递减）📉💸 |
|          | 只是观察者的主观新鲜感逐级衰减、审美疲劳         | 客观投入产出比持续恶化，甚至滑向负收益       |
